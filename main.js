...
const questions = {
    ...
    family:
        [
            {
                text: "Q1. ${username} có chủ động chăm sóc sức khỏe cho bạn không?",
                choices: [
            ...
            {
                text: "Q2. Sự đầu tư về mặt vật chất của ${username} vào việc học của bạn ảnh hưởng đến bạn như thế nào?",
                choices: [
            ...
            {
                text: "Q3. ${username} có giúp đỡ và hỗ trợ bạn trong việc định hướng việc học và nghề nghiệp hay không?",
                choices: [
            ...
            {
                text: "Q4. Sự can thiệp của ${username} vào con đường học của bạn khiến bạn cảm thấy như thế nào?",
                choices: [
            ...
            {
                text: "Q5. Mức độ can thiệp của ${username} ảnh hưởng thế nào đến khả năng tự lập trong học tập của bạn?",
                choices: [
            ...
            {
                text: "Q6. Kỳ vọng của ${username} vào thành tích học tập của bạn khiến bạn cảm thấy như thế nào?",
                choices: [
            ...
            {
                text: "Q7. Thái độ của ${username} như thế nào khi việc học của bạn không đạt được những kì vọng của họ?",
                choices: [
    ...
    love:
        [
            {
                text: "Q1. ${username} có chủ động chăm sóc cho sức khỏe của bạn không?",
                choices: [
                    { text: "Không bao giờ quan tâm", scores: [0, 0, -5, 0, 0, 0] },
                    { text: "Thỉnh thoảng nhắc nhở nhưng không thực sự hành động", scores: [0, 0, 0, 0, 0, 0] },
                    { text: "Quan tâm ở mức vừa phải, chỉ khi bạn cần", scores: [0, 1, 1, 0, 0, 0] },
            ...
            {
                text: "Q2. Bạn có thường học cùng ${username} hay không?",
                choices: [
            ...
            {
                text: "Q3. Hiệu quả từ việc học cùng ${username} như thế nào?",
                choices: [
            ...
            {
                text: "Q4. ${username} có thường rủ bạn đi chơi, giải trí hay tham gia các hoạt động ngoại khóa không?",
                choices: [
            ...
            {
                text: "Q5. Sự ảnh hưởng của những thói quen xấu từ ${username} đến bạn?",
                choices: [
            ...
            {
                text: "Q6. Kì vọng của ${username} vào thành tích học tập của bạn khiến bạn cảm thất như thế nào?",
                choices: [
                    { text: "Rất áp lực", scores: [0, 0, 0, 0, 5, 0] },
                    { text: "Áp lực nhẹ", scores: [0, 0, 0, 0, 2, 0] },
                    { text: "Trung tính, không thấy áp lực", scores: [0, 0, 0, 0, 0, 0] },
    ...
    friends:
        [
            {
                text: "Q1. Bạn có thường học cùng ${username} hay không?",
                choices: [
                    { text: "Luôn luôn", scores: [0, 5, 0, 0, 0, 0] },
                    { text: "Thường xuyên", scores: [0, 4, 0, 0, 0, 0] },
                    { text: "Thỉnh thoảng", scores: [0, 2, 0, 0, 0, 0] },
            ...
            {
                text: "Q2. Hiệu quả từ việc học cùng ${username} như thế nào?",
                choices: [
                    { text: "Rất hiệu quả, rất tập trung và giúp đỡ hỗ trợ nhau rất nhiều", scores: [0, 0, 5, 0, 0, 0] },
            ...
            {
                text: "Q3. ${username} có thường rủ bạn đi chơi, tán gẫu, giải trí hay tham gia các hoạt động ngoại khóa không?",
                choices: [
                    { text: "Luôn luôn", scores: [0, 0, 0, 10, -10, 0] },
                    { text: "Thường xuyên", scores: [0, 0, 0, 8, -8, 0] },
                    { text: "Thỉnh thoảng", scores: [0, 0, 0, 5, -5, 0] },
            ...
            {
                text: "Q4. Sự ảnh hưởng của những thói quen xấu từ ${username} đến bạn?",
                choices: [
                    { text: "Ảnh hưởng tiêu cực rất nhiều", scores: [0, 0, 0, 5, 0, 0] },
                    { text: "Ảnh hưởng tiêu cực nhưng nhẹ", scores: [0, 0, 0, 2, 0, 0] },
                    { text: "Không ảnh hưởng", scores: [0, 0, 0, 0, 0, 0] },
            ...
            {
                text: "Q5. Kì vọng của ${username} vào thành tích học tập của bạn khiến bạn cảm thất như thế nào?",
                choices: [
                    { text: "Rất áp lực", scores: [0, 0, 0, 0, 5, 0] },
                    { text: "Áp lực nhẹ", scores: [0, 0, 0, 0, 2, 0] },
                    { text: "Trung tính, không thấy áp lực", scores: [0, 0, 0, 0, 0, 0] },
    ...
    teacher:
        [
            {
                text: "Q1. Phong cách giảng dạy của ${username} ảnh hưởng thế nào đến bạn?",
                choices: [
            ...
            {
                text: "Q2. ${username} có quan tâm, nhắc nhở về thái độ, tiến độ học tập của bạn hay không?",
                choices: [
            ...
            {
                text: "Q3. Những câu trả lời giải đáp của ${username} có đủ làm bạn hài lòng hay không?",
                choices: [
            ...
            {
                text: "Q4. Những áp lực (giao bài tập, deadline,...) mà ${username} tạo ra cho bạn ảnh hưởng như thế nào đến bạn?",
                choices: [
    ...
    colleague:
        [
            {
                text: "Q1. Cảm giác của bạn khi làm việc nhóm cùng với người ${username}?",
                choices: [
            ...
            {
                text: "Q2. Khi làm việc nhóm, ${username} có tôn trọng ý kiến, đề xuất của bạn không?",
                choices: [
            ...
            {
                text: "Q3. Những áp lực (giao nhiệm vụ, deadline, đòi hỏi về công việc, ...) mà ${username} tạo ra cho bạn ảnh hưởng như thê nào đến bạn?",
                choices: [
...
renderQuestion(relation, questions);
});
...
function renderQuestion(relation, questions) {
  ...
  document.querySelectorAll(".choice").forEach((button) => {
    button.addEventListener("click", (e) => {
      ...
      updateScores(scores);
      slideToNextQuestion(relation,questions);
    });
  });
}

function slideToNextQuestion(relation,questions) {
